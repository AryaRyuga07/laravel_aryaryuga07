    ...
    <div class="container">
        <div class="row shadow-lg rounded-4 overflow-hidden bg-white" style="max-width: 900px; margin:auto;">
            <div class="col-md-6 p-5">
                <h6 class="text-muted">Buat Akunmu</h6>
                ...
                <form method="POST" action="{{ route('doRegister') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="username" class="form-control" placeholder="yourusername">
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-success w-100 rounded-pill">Daftar →</button>
                </form>
            ...
            <div class="col-md-6 p-0">
                <img src="{{ asset('assets/img/hospital2.jpg') }}" class="w-100 h-100" style="object-fit: cover;"
